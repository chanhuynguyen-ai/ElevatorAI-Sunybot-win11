...
SAFE_RUNTIME_MODE = _env_bool("SAFE_RUNTIME_MODE", True)
...
OCCUPANCY_SAMPLE_SEC = _env_int("OCCUPANCY_SAMPLE_SEC", 3)
EVENT_COOLDOWN_SEC = _env_int("EVENT_COOLDOWN_SEC", 8)
POSTURE_EVENT_COOLDOWN_SEC = _env_int("POSTURE_EVENT_COOLDOWN_SEC", 5)
...
SITTING_EVENT_CONFIRM_FRAMES = _env_int("SITTING_EVENT_CONFIRM_FRAMES", 3)
STANDING_EVENT_CONFIRM_FRAMES = _env_int("STANDING_EVENT_CONFIRM_FRAMES", 3)
