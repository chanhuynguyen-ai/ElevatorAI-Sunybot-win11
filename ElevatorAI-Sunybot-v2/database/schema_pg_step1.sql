-- PostgreSQL schema for Sunybot Step 1 (Jetson Nano friendly)
-- Muc tieu:
-- 1) Khoa du lieu co cau truc cho intent / prompt / answer / employee
-- 2) Giu retrieval nhe: full-text + pg_trgm + pgvector cho prompts
-- 3) Khop voi chat_logs runtime (source, answer_preview, tool_trace_json, tool_count)
-- 4) De duong cho Step 2 agent ma khong can doi schema lon
