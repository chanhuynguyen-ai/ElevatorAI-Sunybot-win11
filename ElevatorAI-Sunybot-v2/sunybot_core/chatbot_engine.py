# sunybot_core/chatbot_engine.py
from typing import Dict, Any
from sunybot_core.employee_service import (
    is_employee_code, find_employee_by_code,
    find_employee_by_name, format_employee_answer
)
from sunybot_core.semantic_matcher import SemanticMatcher
from sunybot_core.embedding_service import EmbeddingService
from sunybot_core.ollama_service import OllamaService, FALLBACK_TEXT
...
class ChatbotEngine:
    ...
    def handle(self, user_text: str) -> Dict[str, Any]:
        ...
        # 4) LLM fallback
        llm_ans = self.ollama.chat(q, timeout_sec=60)
